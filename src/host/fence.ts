/**
 * Browser-trust fence for the jupyter plugin routes, behaviorally identical
 ...
 * authentication. Copied here because the shared helper is not exported by
 * the DSH packages (the sidebar plugin does the same).
 */
