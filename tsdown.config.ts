/**
 * tsdown build for @dong-victor/dsh-better-sidebar-jupyter: the host-half
 * lib (lib/index.js, ESM node — the /api/dsh-better-sidebar-jupyter routes
 * and the kernel WebSocket) plus the browser client bundle (lib/client.js,
